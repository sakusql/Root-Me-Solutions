On commence tout à d’abord à lire la belle poésie une ligne sur 2 :
```
...
mettre.
```
Par la suite les réponses s’effectue en lisant le 1er mot de chaque ligne :
```
...
```
Ce qui donne la dernière phrase cachée : *censuré* avec les majuscules au début de chaque mots
